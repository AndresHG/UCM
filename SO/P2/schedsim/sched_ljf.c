...
static task_t* pick_next_task_ljf(runqueue_t* rq,int cpu)
{
...
static void enqueue_task_ljf(task_t* t,int cpu, int runnable)
{
...
static task_t* steal_task_ljf(runqueue_t* rq,int cpu)
{
...
sched_class_t ljf_sched= {
	.pick_next_task=pick_next_task_ljf,
	.enqueue_task=enqueue_task_ljf,
	.steal_task=steal_task_ljf
};
